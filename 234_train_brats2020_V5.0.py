...
sample_img_name = img_list[img_num]
sample_mask_name = sample_img_name.replace('image_', 'mask_')
test_img = np.load(os.path.join(train_img_dir, sample_img_name))
test_mask = np.load(os.path.join(train_mask_dir, sample_mask_name))
...
plt.show()
#################################################
# Model evaluation and prediction using trained model
my_model = model
#################################################
...
if val_files:
    ...
    test_img = np.load(os.path.join(val_img_dir, sample_val_file))
    test_mask = np.load(os.path.join(val_mask_dir, sample_val_file.replace('image_', 'mask_')))
else:
    test_img = np.zeros((128, 128, 128, 3))
    test_mask = np.zeros((128, 128, 128, 4))
